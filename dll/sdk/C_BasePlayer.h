...
public:
	...
	/*3*/	virtual void* GetCollideable(void) = 0;
	...
	/*12*/	virtual void* GetSoundSpatialization(void**) = 0;
	...
	/*16*/	virtual void* FireBullets(void* const&) = 0;
	/*17*/	virtual void* ModifyFireBulletsDamage(void*) = 0;
	/*18*/	virtual bool ShouldDrawUnderwaterBulletBubbles(void) = 0;
	/*19*/	virtual bool ShouldDrawWaterImpacts(void) = 0;
	/*20*/	virtual void* HandleShotImpactingWater(void* const&,Vector const&,ITraceFilter*,Vector*) = 0;
	/*21*/	virtual void* GetBeamTraceFilter(void) = 0;
	/*22*/	virtual void* DispatchTraceAttack(void* const&,Vector const&,CGameTrace*, void*) = 0;
	/*23*/	virtual void* TraceAttack(void* const&,Vector const&,CGameTrace*, void*) = 0;
	...
	/*122*/	virtual bool InSameTeam(void*) = 0;
	...
	/*174*/	virtual void* AttemptToPowerup(int,float,float, void*, void*) = 0;
	/*175*/	virtual bool IsCurrentlyTouching(void)const = 0;
	/*176*/	virtual void* StartTouch(void*) = 0;
	/*177*/	virtual void* Touch(void*) = 0;
	/*178*/	virtual void* EndTouch(void*) = 0;
	...
	/*211*/	virtual void* SetShadowUseOtherEntity(void*) = 0;
	...
	/*221*/	virtual void SetMaterialOverridePointer(void*) = 0;
	...
	/*235*/	virtual void* SetEntity(char const*, void*) = 0;
	...
	/*327*/	virtual void* StartSceneEvent(void*, void*, void*, void*, void*) = 0;
	...
	/*336*/	virtual bool IsInFieldOfView(void*)const = 0;
	/*337*/	virtual bool IsInFieldOfView(Vector const&)const = 0;
	/*338*/	virtual bool IsLineOfSightClear(void*,LineOfSightCheckType)const = 0;
	/*339*/	virtual bool IsLineOfSightClear(Vector const&,LineOfSightCheckType, void*)const = 0;
	/*340*/	virtual void* Weapon_Switch(void*,int) = 0;
	/*341*/	virtual void* Weapon_CanSwitchTo(void*) = 0;
	/*342*/	virtual void* GetActiveWeapon(void)const = 0;
	...
	/*356*/	virtual bool IsUseableEntity(void*,unsigned int) = 0;
	...
	/*380*/	virtual void* Weapon_SetLast(void*) = 0;
	/*381*/	virtual void* Weapon_ShouldSetLast(void*, void*) = 0;
	/*382*/	virtual void* Weapon_ShouldSelectItem(void*) = 0;
	...
	/*394*/	virtual void* SetAnimation(void*) = 0;
	...
	/*403*/	virtual void* OnEmitFootstepSound(void* const&,Vector const&,float) = 0;
	...
	/*410*/	virtual void* GetChaseCamViewOffset(void*) = 0;
