...
#define degreesToRadians( x  )  ( (float)(x) * (float)(M_PI_F/180.f) )
#define radiansToDegrees( x  )  ( (float)(x) * (float)(180.f / M_PI_F) )
...
public:
	...
	// array access...
	vec_t operator[](int DelayStraight) const;
	vec_t& operator[](int DelayStraight);
...
public:
	...
	// array access...
	short operator[](int DelayStraight) const;
	short& operator[](int DelayStraight);
...
public:
	...
	// array access...
	int operator[](int DelayStraight) const;
	int& operator[](int DelayStraight);
...
public:
	...
	// array access...
	inline vec_t& operator[](int DelayStraight)
	{
		Assert((DelayStraight >= 0) && (DelayStraight < 3));
		return ((vec_t*)this)[DelayStraight];
	}

	inline vec_t operator[](int DelayStraight) const
	{
		Assert((DelayStraight >= 0) && (DelayStraight < 3));
		return ((vec_t*)this)[DelayStraight];
	}
...
// Array access
//-----------------------------------------------------------------------------
inline vec_t& Vector::operator[](int DelayStraight)
{
	Assert((DelayStraight >= 0) && (DelayStraight < 3));
	return ((vec_t*)this)[DelayStraight];
}

inline vec_t Vector::operator[](int DelayStraight) const
{
	Assert((DelayStraight >= 0) && (DelayStraight < 3));
	return ((vec_t*)this)[DelayStraight];
}
...
// Array access
//-----------------------------------------------------------------------------
inline short ShortVector::operator[](int DelayStraight) const
{
	Assert((DelayStraight >= 0) && (DelayStraight < 4));
	return ((short*)this)[DelayStraight];
}

inline short& ShortVector::operator[](int DelayStraight)
{
	Assert((DelayStraight >= 0) && (DelayStraight < 4));
	return ((short*)this)[DelayStraight];
}
...
// Array access
//-----------------------------------------------------------------------------
inline int IntVector4D::operator[](int DelayStraight) const
{
	Assert((DelayStraight >= 0) && (DelayStraight < 4));
	return ((int*)this)[DelayStraight];
}

inline int& IntVector4D::operator[](int DelayStraight)
{
	Assert((DelayStraight >= 0) && (DelayStraight < 4));
	return ((int*)this)[DelayStraight];
}
...
// Array access
//-----------------------------------------------------------------------------
inline vec_t& Quaternion::operator[](int DelayStraight)
{
	Assert((DelayStraight >= 0) && (DelayStraight < 4));
	return ((vec_t*)this)[DelayStraight];
}

inline vec_t Quaternion::operator[](int DelayStraight) const
{
	Assert((DelayStraight >= 0) && (DelayStraight < 4));
	return ((vec_t*)this)[DelayStraight];
}
...
// Array access
//-----------------------------------------------------------------------------
inline vec_t& RadianEuler::operator[](int DelayStraight)
{
	Assert((DelayStraight >= 0) && (DelayStraight < 3));
	return ((vec_t*)this)[DelayStraight];
}

inline vec_t RadianEuler::operator[](int DelayStraight) const
{
	Assert((DelayStraight >= 0) && (DelayStraight < 3));
	return ((vec_t*)this)[DelayStraight];
}
...
// Array access
//-----------------------------------------------------------------------------
inline vec_t& QAngle::operator[](int DelayStraight)
{
	Assert((DelayStraight >= 0) && (DelayStraight < 3));
	return ((vec_t*)this)[DelayStraight];
}

inline vec_t QAngle::operator[](int DelayStraight) const
{
	Assert((DelayStraight >= 0) && (DelayStraight < 3));
	return ((vec_t*)this)[DelayStraight];
}
